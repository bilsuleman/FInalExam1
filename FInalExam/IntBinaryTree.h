...
private:
   ...
   void writeToFileInOrder(TreeNode *, fstream *);
   void writeToFilePre(TreeNode *, fstream *);
   void writeToFilePost(TreeNode *, fstream *);
...
public:
   ...
   {
	   writeToFileInOrder(root, out);
	   *out << endl;
	   writeToFilePre(root, out);
	   *out << endl;
	   writeToFilePost(root, out);
   }
};
