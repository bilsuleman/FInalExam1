...
void IntBinaryTree::writeToFileInOrder(TreeNode * tree, fstream *out)
{
	if (tree)
	{
		writeToFileInOrder(tree->left, out);
		*out << tree->value << "  ";
		writeToFileInOrder(tree->right, out);
	}

}
void IntBinaryTree::writeToFilePre(TreeNode * tree, fstream *out)
{
	if (tree)
	{
		*out << tree->value << "  ";
		writeToFilePre(tree->left, out);
		writeToFilePre(tree->right, out);
	}
}
void IntBinaryTree::writeToFilePost(TreeNode * tree, fstream *out)
{
	if (tree)
	{
		writeToFilePost(tree->left, out);
		writeToFilePost(tree->right, out);
		*out << tree->value << "  ";
	}
}
